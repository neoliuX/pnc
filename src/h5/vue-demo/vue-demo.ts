...
import Form from '@components/form/demo/FormDemo.vue'
import Dialog from '@components/dialog/demo/DialogDemo.vue'
import Head from '@components/head/demo/HeadDemo.vue'
import Foot from '@components/foot/demo/FootDemo.vue'
