 ...
 * under MIT license
*/
export default function funParabola (element: HTMLElement, target: HTMLElement, options: { speed?: number, curvature?: number, progress?: Function, complete?: Function } = {}) {
  /*
   * 网页模拟现实需要一个比例尺
  ...
  */
  ...
  if (element && target && element.nodeType === 1 && target.nodeType === 1) {
    ...
    var centerElement: any = {}
    var centerTarget: any = {}

    // 目标元素的坐标位置
    var coordElement: any = {}
    var coordTarget: any = {}
